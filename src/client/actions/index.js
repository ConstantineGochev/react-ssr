...
export const fetch_boats_data = () => async dispatch => {
    ...
    const res = await axios.get('https://shielded-springs-23426.herokuapp.com/charters');
    console.log(res)
...
export const fetch_single_boat_data = (id) => async dispatch => {
  //custom async action
    ...
    //     }
    //   }
        const data = await axios.get(`https://shielded-springs-23426.herokuapp.com/charters/${id}`)
        dispatch({
          type: BOAT_DATA,
          payload: data
        })
